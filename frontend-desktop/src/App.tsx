...
export default function App() {
  ...
  // Draft generated by AgentWidget → shown in the notch
  const [draft, setDraft] = useState<{ type: 'email' | 'document'; content: string } | null>(null);
  ...
  return (
    <>
      ...
      >
        ...
        <AgentWidget onDraftGenerated={setDraft} />
      </div>
    </>
  );
}
