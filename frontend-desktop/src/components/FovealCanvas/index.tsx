    ...
    >
      <div className={`${styles.cardImgWrap} ${styles.figmaImgWrap}`}>
        ...
        <div className={styles.cardHeader}>
          ...
          <div className={`${styles.cardTypeIcon} ${styles.figmaBadge}`}>
            <FigmaLogo />
          </div>
        </div>
        <div className={styles.cardFooter}>
      ...
      <div className={`${styles.cardImgWrap} ${styles.notionImgWrap}`}>
        ...
        <div className={styles.cardHeader}>
          ...
          <div className={`${styles.cardTypeIcon} ${styles.notionBadge}`}>
            {page.icon
              ? <span className={styles.notionIcon}>{page.icon}</span>
              : <NotionLogo />}
          </div>
        </div>
        <div className={styles.cardFooter}>
          <div className={styles.cardTitleBlock}>
            <span className={styles.cardFolder}>
              {page.objectType === 'database' ? 'Database' : 'Notion'}
            </span>
    ...
    >
      <div className={`${styles.cardImgWrap} ${styles.youtubeImgWrap}`}>
        ...
        <div className={styles.cardHeader}>
          ...
          <div className={`${styles.cardTypeIcon} ${styles.youtubeBadge}`}>
            <YouTubeLogo />
          </div>
        </div>
        <div className={styles.cardFooter}>
...
// ── Gmail signal card ──────────────────────────────────────
function GmailSignalCard({
  signal, index, theme, onDismiss,
}: {
  signal:    GmailSignal;
  index:     number;
  theme:     Theme;
  ...
  return (
    <div
      className={`${styles.signal} ${styles.signalGmail} ${styles[`signal_${theme}`]}`}
      style={{ top: 100 + index * 72, animationDelay: `${index * 60}ms` }}
    >
      ...
      <button
        className={`${styles.doneBtn} ${styles[`doneBtn_${theme}`]} ${styles.doneBtnGmail}`}
